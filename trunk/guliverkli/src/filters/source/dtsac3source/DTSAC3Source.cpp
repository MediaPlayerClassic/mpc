...
{
	{ L"DTS/AC3 Source"
	, &__uuidof(CDTSAC3Source)
	, CDTSAC3Source::CreateInstance
	, NULL
	, &sudFilter}
};
...
CUnknown* WINAPI CDTSAC3Source::CreateInstance(LPUNKNOWN lpunk, HRESULT* phr)
{
    CUnknown* punk = new CDTSAC3Source(lpunk, phr);
