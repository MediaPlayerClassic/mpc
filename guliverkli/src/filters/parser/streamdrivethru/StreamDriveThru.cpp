...
{
	{ L"StreamDriveThru"
	, &__uuidof(CStreamDriveThruFilter)
	, CStreamDriveThruFilter::CreateInstance
	, NULL
	, &sudFilter}
};
...
CUnknown* WINAPI CStreamDriveThruFilter::CreateInstance(LPUNKNOWN lpunk, HRESULT* phr)
{
    CUnknown* punk = new CStreamDriveThruFilter(lpunk, phr);
