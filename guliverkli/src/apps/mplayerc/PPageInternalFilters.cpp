...
s_filters[] = 
{
	...
	{_T("AAC"), 1, TRA_AAC, IDS_TRA_AAC, NULL},
	{_T("AC3"), 1, TRA_AC3, IDS_TRA_AC3, NULL},
	{_T("DTS"), 1, TRA_DTS, IDS_TRA_DTS, NULL},
	{_T("Dirac"), 1, TRA_DIRAC, IDS_TRA_DIRAC, NULL},
	{_T("LPCM"), 1, TRA_LPCM, IDS_TRA_LPCM, NULL},
	{_T("MPEG Audio"), 1, TRA_MPA, IDS_TRA_MPA, NULL},
	...
	{_T("PS2 Audio (PCM/ADPCM)"), 1, TRA_PS2AUD, IDS_TRA_PS2AUD, NULL},
