...
namespace Matroska
{
	...
	class CByte : public CSimpleVar<BYTE, CByte> {public: HRESULT Parse(CMatroskaNode* pMN);};
	class CShort : public CSimpleVar<short, CShort> {public: HRESULT Parse(CMatroskaNode* pMN);};
	class CFloat : public CSimpleVar<float, CFloat> {public: HRESULT Parse(CMatroskaNode* pMN);};
...
//				BlockVirtual
	...
	public:
		CID m_id;
		CLength m_len;
		QWORD m_start, m_next;

		HRESULT Parse(CMatroskaNode* m_pMN);
